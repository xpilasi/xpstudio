...
<template>
  <section class="bg-coolGreen text-white px-4 sm:px-6 lg:px-50 2xl:px-90 min-h-screen hero-diagonal">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-7 gap-8 lg:gap-0 items-center w-full">
        ...
        <div class="order-2 lg:col-span-3">
          ...
          <div class="hidden lg:flex lg:flex-row justify-center items-center" style="height: 80vh;">
            <img :src="PandaCool" alt="Hero Panda Character" class="h-6/7 object-cover">
          </div>

          <!-- Mobile and Tablet Version -->
          <HeroMobile 
            :image-url="PandaCool"
            image-alt="Hero Panda Character"
            primary-decor-color="bg-coolYellow"
            secondary-decor-color="bg-coolBlue"
            glow-from-color="from-coolYellow/20"
            glow-to-color="to-coolBlue/20"
